...
$req = $wpdb->get_row($wpdb->prepare("
    SELECT r.*, s.name as service_name, s.description as service_desc, m.name as member_name, m.national_id, m.membership_number, m.governorate, m.professional_grade, m.specialization
...
<body>
    ...
    <table class="content-table">
        ...
        <tr><td>الدرجة الوظيفية:</td><td><?php echo esc_html(SM_Settings::get_professional_grades()[$req->professional_grade] ?? $req->professional_grade); ?></td></tr>
        <tr><td>التخصص:</td><td><?php echo esc_html(SM_Settings::get_specializations()[$req->specialization] ?? $req->specialization); ?></td></tr>
